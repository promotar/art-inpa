...
$sync = app(AiServerSyncService::class);
$freshSnapshot = $sync->freshHealthSnapshot($user);
$latestSnapshot = $sync->latestSnapshot();
$readiness = [];
...
$aiCorePrecheck = [
    'generate_image' => $core->usageAllowed($user, 'generate_image'),
    'image_generate' => $core->usageAllowed($user, 'image_generate'),
];
...
echo json_encode([
    ...
    'ai_core_precheck' => $aiCorePrecheck,
