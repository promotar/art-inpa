...
class ProfessionalProgrammerServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        require_once __DIR__.'/ProfessionalProgrammerLearningVerificationService.php';
        require_once __DIR__.'/ProfessionalProgrammerProductionGuard.php';
        require_once __DIR__.'/ProfessionalProgrammerIncidentAnalyzer.php';
        require_once __DIR__.'/ProfessionalProgrammerAiGateway.php';
