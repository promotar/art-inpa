...
return new class extends Migration
{
    ...
    private function registerSettings(): void
    {
        ...
        $settings = [
            ...
            'gateway_url' => ['AI Gateway URL', 'text', 'http://10.10.0.40:8080', 'Internal Art INPA AI Gateway URL used by the coding assistant.', 100, 'text', false, null, null],
        ...
        foreach ($settings as $key => $definition) {
            ...
            $payload = [
                ...
                'editable' => true,
                'required' => in_array($key, ['enabled', 'gateway_url'], true),
                ...
                'approval_required' => $key === 'gateway_url',
                'status' => 'active',
                'version' => 1,
                'updated_at' => now(),
                'created_at' => now(),
